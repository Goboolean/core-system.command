...
import (
	"context"
	"fmt"
	metadataapi "github.com/Goboolean/core-system.command/api/grpc/metadata"
	modelapi "github.com/Goboolean/core-system.command/api/grpc/model"
	simulationapi "github.com/Goboolean/core-system.command/api/grpc/simulation"
	userapi "github.com/Goboolean/core-system.command/api/grpc/user"
	metadata "github.com/Goboolean/core-system.command/internal/adapter/grpc/metadata"
	model "github.com/Goboolean/core-system.command/internal/adapter/grpc/model"
	simulation "github.com/Goboolean/core-system.command/internal/adapter/grpc/simulation"
	user "github.com/Goboolean/core-system.command/internal/adapter/grpc/user"
